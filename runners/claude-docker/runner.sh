...
DEFAULT_PASSTHROUGH="\
TASKPUMP_PRE_FLIGHT \
TASKPUMP_WORKSPACE_TASK_CLI \
TASKPUMP_CONTAINER_USER \
TASKPUMP_CONTAINER_HOME \
TASKPUMP_SAFETY_TURNS \
TASKPUMP_TASKS_DIR \
TASKPUMP_TASK_OUT \
TASKPUMP_TASK_FILE_EXT \
TASKPUMP_AGENT_LOG_NAME \
TASKPUMP_GOAL_NOTE_NAME \
TASKPUMP_RESUME_NOTE_NAME \
TASKPUMP_RO_PROBE_FILE \
TASKPUMP_CRED_REFRESH_INTERVAL_S \
TASKPUMP_AGENT_WALL_TIMEOUT_S \
